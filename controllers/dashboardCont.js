                ...
                if (err) {
                    ...
                    try {
                        if (req.body.name == req.params.name) {
                            ...
                            existingEvent.registration_starts =
                                registration_starts;
                            ...
                            existingEvent.result_declaration =
                                result_declaration;
                            ...
                            Event.findOne(
                                ...
                                (err, foundEvent2) => {
                                    if (err) {
                                        ...
                                        existingEvent.registration_starts =
                                            registration_starts;
                                        existingEvent.registration_ends =
                                            registration_ends;
                                        existingEvent.event_starts =
                                            event_starts;
                                        existingEvent.event_ends = event_ends;
                                        existingEvent.result_declaration =
                                            result_declaration;
