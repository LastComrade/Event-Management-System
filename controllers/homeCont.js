            ...
            async (err, foundReciever) => {
                if (err) {
                    ...
                    sheeteditor = async (client) => {
                        ...
                        const options1 = {
                            spreadsheetId:
                                process.env.magazineRecievers_spreadsheet_id,
                    ...
                    return res.json({
                        message:
                            "Email registered successfully for the monthly magazine",
                    });
                } else {
                    // sheet API code
                    let client_side = new google.auth.JWT(
                    ...
                    return res.json({
                        message:
                            "You have successfully subscribed to our Monthly Magazine",
                    });
                }
            }
        );
