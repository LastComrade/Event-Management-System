$(function () {
  ...
  $(window).on("scroll", function (event) {
    ...
    if (scroll < 20) {
      $(".navbar-area").removeClass("custom-sticky");
      $(".scroll-page").removeClass("text-black");
      $(".navbar-brand-name").removeClass("text-black");
      $(".navbar-brand-name").addClass("text-white");
      $(".navbar .navbar-brand img").attr("src", "assets/images/logo.svg");
    } else {
      $(".navbar-area").addClass("custom-sticky text-black");
      $(".scroll-page").addClass("text-black");
      $(".navbar-brand-name").addClass("text-black");
      $(".navbar-brand-name").removeClass("text-white");
      $(".navbar .navbar-brand img").attr("src", "assets/images/logo.svg");
    }
  });
  var scrollLink = $(".scroll-page");
  ...
  if (document.getElementById("particles-1"))
    particlesJS("particles-1", {
      particles: {
        number: {
          value: 40,
          density: { enable: !0, value_area: 4000 },
        },
